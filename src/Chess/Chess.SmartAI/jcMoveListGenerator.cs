...
namespace Chess.SmartAI
{
    public class jcMoveListGenerator
    {
        ...
        // Accessors
        public List<jcMove> GetMoveList() { return Moves; }
        public int Size() { return Moves.Count; }

        // public bool Find( jcMove mov )
        ...
        {
            if (MovesIt.MoveNext())
                return (jcMove)MovesIt.Current;
            else
                return null;
        }

        // public bool ComputeLegalMoves
        ...
        public bool ComputeLegalMoves(jcBoard theBoard)
        {
            ...
            if (theBoard.GetCurrentPlayer() == jcPlayer.SIDE_WHITE)
            {
                ...
                if (!ComputeWhiteKingMoves(theBoard))
                    return false;
                if (!ComputeWhiteRookMoves(theBoard, jcBoard.WHITE_ROOK))
                    return false;
                if (!ComputeWhiteBishopMoves(theBoard, jcBoard.WHITE_BISHOP))
                    return false;
            ...
            else
            {
                ...
                if (!ComputeBlackKingMoves(theBoard))
                    return false;
                if (!ComputeBlackRookMoves(theBoard, jcBoard.BLACK_ROOK))
                    return false;
                if (!ComputeBlackBishopMoves(theBoard, jcBoard.BLACK_BISHOP))
                    return false;
        ...
        // public bool ComputeQuiescenceMoves
        // Find only the moves which are relevant to quiescence search; i.e., captures
        public bool ComputeQuiescenceMoves(jcBoard theBoard)
        {
        ...
        public void Print()
        {
            ...
            for (int it = 0; it < Moves.Count; it++)
            {
                jcMove mov = (jcMove)Moves[it];
                mov.Print();
            }
        }
        ...
        private bool ComputeWhiteQueenMoves(jcBoard theBoard)
        {
            if (!ComputeWhiteBishopMoves(theBoard, jcBoard.WHITE_QUEEN))
                return false;
            if (!ComputeWhiteRookMoves(theBoard, jcBoard.WHITE_QUEEN))
                return false;
            return true;
        }

        private bool ComputeWhiteKingMoves(jcBoard theBoard)
        {
        ...
        // private bool ComputeWhiteRookMoves
        // Receives an extra "pieceType" parameter, because the queen AND the rook
        // need to use this function
        private bool ComputeWhiteRookMoves(jcBoard theBoard, int pieceType)
        {
        ...
        private bool ComputeWhiteBishopMoves(jcBoard theBoard, int pieceType)
        {
            // Fetch the bitboard containing positions of these pieces
            long pieces = theBoard.GetBitBoard(pieceType);
        ...
        private bool ComputeWhiteKnightMoves(jcBoard theBoard)
        {
            // Fetch the bitboard containing positions of these pieces
        ...
        private bool ComputeWhitePawnMoves(jcBoard theBoard)
        {
            // Fetch the bitboard containing positions of these pieces
        ...
        private bool ComputeBlackQueenMoves(jcBoard theBoard)
        {
            if (!ComputeBlackRookMoves(theBoard, jcBoard.BLACK_QUEEN))
                return false;
            if (!ComputeBlackBishopMoves(theBoard, jcBoard.BLACK_QUEEN))
                return false;
            return true;
        }

        private bool ComputeBlackKingMoves(jcBoard theBoard)
        {
            // Fetch the bitboard containing position of the king
        ...
        private bool ComputeBlackRookMoves(jcBoard theBoard, int pieceType)
        {
            // Fetch the bitboard containing positions of these pieces
            long pieces = theBoard.GetBitBoard(pieceType);
        ...
        private bool ComputeBlackBishopMoves(jcBoard theBoard, int pieceType)
        {
            // Fetch the bitboard containing positions of these pieces
            long pieces = theBoard.GetBitBoard(pieceType);
        ...
        private bool ComputeBlackKnightMoves(jcBoard theBoard)
        {
            // Fetch the bitboard containing positions of these pieces
        ...
        private bool ComputeBlackPawnMoves(jcBoard theBoard)
        {
            // Fetch the bitboard containing positions of these pieces
        ...
        *************************************************************************/
        ...
        static jcMoveListGenerator()
        {
            ...
            BishopMoves[0] = new int[1][];
            BishopMoves[0][0] = new int[7];
            BishopMoves[0][0][0] = 9;
            ...
            BishopMoves[7] = new int[1][];
            BishopMoves[7][0] = new int[7];
            ...
            BishopMoves[56] = new int[1][];
            BishopMoves[56][0] = new int[7];
            ...
            BishopMoves[63] = new int[1][];
            BishopMoves[63][0] = new int[7];
